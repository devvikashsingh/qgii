...
class Module extends \yii\base\Module implements BootstrapInterface
{
    ...
    protected function coreGenerators()
    {
        return [
            'qmodel' => [
                'class' => 'app\modules\qgii\generators\model\Generator'
            ],
            'qcrud' => [
                'class' => 'app\modules\qgii\generators\crud\Generator'
            ],
            'qcontroller' => [
                'class' => 'app\modules\qgii\generators\controller\Generator'
            ],
            'qform' => [
                'class' => 'app\modules\qgii\generators\form\Generator'
            ],
            'qmodule' => [
                'class' => 'app\modules\qgii\generators\module\Generator'
            ],
            'qextension' => [
                'class' => 'app\modules\qgii\generators\extension\Generator'
            ],
            'model' => [
